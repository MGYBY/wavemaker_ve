...
function [U,ttime] = runSimulation(parameter)
clc; clear;
...
format long
        ...
        parameter.UseExistingInitialCondition = false;
        parameter.stSine = 0.2;
        parameter.spSine = 0.0;
        parameter.stCosine = 0;
        parameter.spCosine = 0;
        parameter.stNoise = 0;
        parameter.spNoise = 0;
        parameter.stNwaves = 1;
        parameter.spNwaves = 1;
        ...
        while(tmax-ttime>prtstep)
            ...
            while (ttime<stop)        % Loop over prtstep
                ...
                if parameter.Model == 1 %Start with simplified model
                    if(GPU == true)
                        % FIXME: change this syntax here for GPU
