...
% *                       and Benoit Scheid
% *       TIPs lab � Microfluidics, Universit� Libre de Bruxelles   *
% *******************************************************************
%
...
set(handles.Reynolds,'String',sprintf('%.5g',Reynolds));
set(handles.Kapitza,'String',sprintf('%.5g',Kapitza));
set(handles.Ct,'String',sprintf('%.5g',Ct));

set(handles.k0x,'String',sprintf('%.5g',k0x));
set(handles.k0z,'String',sprintf('%.5g',k0z));
...
set(handles.Value_Shkadov_delta,'String',sprintf('%.5g',Shkadov_delta));
set(handles.Value_Shkadov_eta,'String',sprintf('%.5g',Shkadov_eta));
set(handles.Value_Shkadov_zeta,'String',sprintf('%.5g',Shkadov_zeta));
set(handles.Value_Shkadov_k0x,'String',sprintf('%.5g',Shkadov_k0x));
set(handles.Value_Shkadov_k0z,'String',sprintf('%.5g',Shkadov_k0z));
 %set(handles.Value_Shkadov_k0z,'String',sprintf('%.5g',Shkadov_k0z));
...
set(handles.Nu,'String',sprintf('%.5g',Dim_nu));
set(handles.gAbs,'String',sprintf('%.5g',Dim_gAbs));
set(handles.FluidProperties_rho,'String',sprintf('%.5g',Dim_rho));
...
set(handles.FluidProperties_Sigma,'String',sprintf('%.5g',FluidProp_sigma));
set(handles.Dimensional_Filmthickness,'String',sprintf('%.5g',Dim_Filmthickness));
set(handles.Dimensional_InclinationAngle,'String',sprintf('%.5g',Dim_InclinationAngle));
set(handles.Lx,'String',sprintf('%.5g',Dim_Lx));
set(handles.Lz,'String',sprintf('%.5g',Dim_Lz));
...
try
    ...
    set(handles.Reynolds,'String',sprintf('%.5g',parameter.Reynolds));
    set(handles.Kapitza,'String',sprintf('%.5g',parameter.Kapitza));
    set(handles.Ct,'String',sprintf('%.5g',parameter.Ct));
    set(handles.h0,'String',sprintf('%.5g',parameter.h0));
    set(handles.k0x,'String',sprintf('%.5g',parameter.Nusselt_k0x));
    set(handles.k0z,'String',sprintf('%.5g',parameter.Nusselt_k0z));
    
    [~,name,~] = fileparts(FileName);
    set(handles.ParameterFileName,'String',name);
    
    set(handles.Value_Shkadov_delta,'String',sprintf('%.5g',parameter.Shkadov_delta));
    set(handles.Value_Shkadov_eta,'String',sprintf('%.5g',parameter.Shkadov_eta));
    set(handles.Value_Shkadov_zeta,'String',sprintf('%.5g',parameter.Shkadov_zeta));
    
    set(handles.GPU_Acceleration,'Value',parameter.GPU_Acceleration);
    
    set(handles.Value_Shkadov_k0x,'String',sprintf('%.5g',parameter.Shkadov_k0x));
    set(handles.Value_Shkadov_k0z,'String',sprintf('%.5g',parameter.Shkadov_k0z));
    
    
    set(handles.Nu,'String',sprintf('%.5g',parameter.DimVar_nu));
    set(handles.FluidProperties_rho,'String',sprintf('%.5g',parameter.DimVar_rho));
    set(handles.FluidProperties_Sigma,'String',sprintf('%.5g',parameter.DimVar_sigma));
    set(handles.gAbs,'String',sprintf('%.5g',parameter.DimVar_gAbs));
    set(handles.Dimensional_Filmthickness,'String',sprintf('%.5g',parameter.DimVar_hN));
    set(handles.Dimensional_InclinationAngle,'String',sprintf('%.5g',parameter.DimVar_Theta));
    set(handles.Lx,'String',sprintf('%.5g',parameter.DimVar_Lx));
    set(handles.Lz,'String',sprintf('%.5g',parameter.DimVar_Lz));
    
    set(handles.NNstPop,'Value',(parameter.NNst));
    set(handles.NNspPop,'Value',(parameter.NNsp+1));
    
    set(handles.TMax,'String',sprintf('%.5g',parameter.TMax));
    set(handles.PrtStep,'String',sprintf('%.5g',parameter.PrtStep));
    set(handles.AlaisingRadius,'String',sprintf('%.5g',parameter.AlaisingRadius));
...
kappa=3*Reynolds/Shkadov_delta;
set(handles.k0x,'String',sprintf('%.5g',Shkadov_k0x/kappa));
set(handles.k0z,'String',sprintf('%.5g',Shkadov_k0z/kappa));
...
set(handles.Nu,'String',sprintf('%.5g',FluidProp_Nu));
set(handles.FluidProperties_rho,'String',sprintf('%.5g',FluidProp_rho));
set(handles.FluidProperties_Sigma,'String',sprintf('%.5g',FluidProp_sigma));
end
...
set(handles.Value_Shkadov_zeta,'String',sprintf('%.5g',Shkadov_zeta));
kappa=3*Reynolds/Shkadov_delta;
set(handles.Value_Shkadov_k0x,'String',sprintf('%.5g',k0x*kappa));
set(handles.Value_Shkadov_k0z,'String',sprintf('%.5g',k0z*kappa));
...
defaultanswer={sprintf('%.5g',handles.stSine), sprintf('%.5g',handles.stCosine), sprintf('%.5g',handles.spSine),...
    sprintf('%.5g',handles.spCosine), sprintf('%.5g',handles.stNoise), sprintf('%.5g',handles.spNoise), sprintf('%.5g',handles.stNwaves), sprintf('%.5g',handles.spNwaves)};
...
if handles.Old_LstBxValue == 1 && handles.New_LstBxValue == 2
    set(handles.TMax,'String',sprintf('%.5g',Tend_old*hnDach/(tv*lv)));
    set(handles.PrtStep,'String',sprintf('%.5g',PrtStep_old*hnDach/(tv*lv)));
end

if handles.Old_LstBxValue == 1 && handles.New_LstBxValue == 3
    set(handles.TMax,'String',sprintf('%.5g',Tend_old*hnDach/(tv*lv*parameter.Shkadov_kappa)));
    set(handles.PrtStep,'String',sprintf('%.5g',PrtStep_old*hnDach/(tv*lv*parameter.Shkadov_kappa)));
end

if handles.Old_LstBxValue == 2 && handles.New_LstBxValue == 1
    set(handles.TMax,'String',sprintf('%.5g',Tend_old*(tv*lv)/hnDach));
    set(handles.PrtStep,'String',sprintf('%.5g',PrtStep_old*(tv*lv)/hnDach));
end

if handles.Old_LstBxValue == 2 && handles.New_LstBxValue == 3
    set(handles.TMax,'String',sprintf('%.5g',Tend_old/parameter.Shkadov_kappa));
    set(handles.PrtStep,'String',sprintf('%.5g',PrtStep_old/parameter.Shkadov_kappa));
end

if handles.Old_LstBxValue == 3 && handles.New_LstBxValue == 1
    set(handles.TMax,'String',sprintf('%.5g',Tend_old*tv*lv/hnDach*parameter.Shkadov_kappa));
    set(handles.PrtStep,'String',sprintf('%.5g',PrtStep_old*tv*lv/hnDach*parameter.Shkadov_kappa));
end
